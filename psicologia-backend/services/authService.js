    ...
    const transporter = nodemailer.createTransport({
        ...
        const mailOptions = {
            ...
            html: `
                ...
                <a href="${process.env.NEXT_PUBLIC_API_URL}/restablecer-clave?token=${token}">Restablecer Contraseña</a>
...
exports.enviarCorreoVerificacion = async (correo, token) => {
    ...
    const mailOptions = {
        ...
        html: `
            ...
            <a href="${process.env.NEXT_PUBLIC_API_URL}/verificar-correo?token=${token}">Verificar correo</a>
